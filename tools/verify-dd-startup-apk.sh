...
echo "DDSTART2 comparison, DDSTART1 logging, DDSTART3 trace markers, DDSTART4 BM handshake markers, DDSTART5 context, and DDSTART6 scheduler markers verified in packaged arm64-v8a native core"
shasum -a 256 "$1"