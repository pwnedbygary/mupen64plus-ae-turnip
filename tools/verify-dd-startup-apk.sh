...
echo "DDSTART2 comparison, DDSTART1 logging, DDSTART3 trace markers, DDSTART4 BM handshake markers, DDSTART5 context, DDSTART6 scheduler, and DDSTART7 fault markers verified in packaged arm64-v8a native core"
shasum -a 256 "$1"